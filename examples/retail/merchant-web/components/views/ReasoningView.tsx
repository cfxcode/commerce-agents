...
export default function ReasoningView({ refreshKey, sessionId }: { refreshKey: number; sessionId: string }) {
  ...
  return (
    <div className="min-w-0 space-y-5 p-4 lg:p-6" data-testid="reasoning-inspector">
